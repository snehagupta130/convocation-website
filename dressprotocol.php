...
<section class="service white-bg page-section-ptb">
  <div class="container">
            ...
            <p>2. &nbsp;&nbsp;</p>
              <p>Lady graduands are required to come in one of the following attires:</p></div>

              <div style="padding-inline: 30px; display: flex; ">
              <p>2.1 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
              <p>Plain or self-design, white or off-white cotton kameez with collar coupled with salwar or churridar or pant-cut bottom.</p></div>
            ...
            <div style="display: flex; ">
            <p>3. &nbsp;&nbsp;</p>
              <p>Foot-wear: black or brown formal shoes or sandals or kolhapuri chappals but no rubber chappals</p></div>
